...
<div class="col-md-12 col-sm-12 col-xs-12">
   ...
   <div class="w3-card-4" style="width:100%;">
    <header class="w3-container w3-red">
      <h3>SUPERVISOR PART : Quantitative Part II And Qualitative Part</h3>
    </header>
...
<h4 class="w3-text-red" style="padding: 10px;"><b>Quantitative Part II :  {{ number_format((float)$qua['score'],2,'.','')}}% Of 10% </b></h4>
<div class="table-responsive">
<table class="table table-striped table-bordered table-hover">
<thead>
<tr>
...
<table class="table table-striped table-bordered table-hover">
<thead>
<h4 class="w3-text-red"><b>Qualitative Score: {{ number_format((float)$qual['score'],2,'.','')}}%</b> </h4>
<tr>
<th  class="w3-purple">#</th>
<th  class="w3-purple">Question</th>
<th  class="w3-purple">Mark</th>
...
<tr>
<th class="w3-red">Hr Name</th>
<th  class="w3-red">Recommendation</th>
<th  class="w3-red">Result</th>
<th  class="w3-red">Result Interpretation</th>
</tr>
</thead>
<tbody>
<tr>
...
<form  method="POST" action="{{ route('mdsubmitappraisal') }}">
@csrf
<input type="text" style="font-size:13pt;" name="rid" value=" {{ $result['id']}} " hidden>

<input type="text" style="font-size:13pt;" name="code" value="{{ $result['code']}}" hidden >
...
<div class="w3-card-4" style="width:100%;">
    <header class="w3-container w3-red">
      <h3>MD COMMENT AND RECOMMENDATION</h3>
    </header>

    <div class="w3-container"><br><br>
      <textarea class="form-control text-center" name="comandrecom" rows="4" style=" font-size:13pt;" required/> </textarea><br><br>
      <button type="submit" class="btn btn-lg btn-primary w3-text-white"  style="background: red;"> Submit Record </button><br><br><br><br>
    </div>
</form>
