...
<div class="form-group input-group">
 ...
 <input type="file" id="profilepic" class="form-control" name="profilepic" required/>   
...
<div class="form-group" >
<lable>D O B</lable>  <input type="date" id="dob" name="dob" > 
</div>              
...
<div class="form-group" >
<label>D O E</label> <input type="date" id="doe" name="doe" /> 
</div>     
