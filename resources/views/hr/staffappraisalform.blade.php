...
<h4><b>Quantitative (70% Maximum Score)</b></h4>
<h6><b>Financial Controller :</b> {{ $quant['finconname']}}</h6>
<h6><b>Total Score :</b> {{ number_format((float)$quant['score'],2,'.','')}} %</h6><br>
<h5><b></b></h5>
...
<b><h2 class="w3-text-red"> Total Score in all section is : {{$total}}%  </b> </h2> 
<b><h4 class="w3-text-red">Interpretation : {{$meaning}} </b> </h4> 
</div>
<hr>
<form  method="POST" action="{{ route('hrsubmitappraisal') }}">
@csrf
<input type="text" style="font-size:13pt;" name="qid" value=" {{ $qual['id']}} " hidden>

<input type="text" style="font-size:13pt;" name="code" value="{{ $qual['code']}}" hidden >
...
<div class="w3-card-4" style="width:100%;">
    <header class="w3-container w3-purple">
      <h3>HR COMMENT AND RECOMMENDATION</h3>
    </header>
