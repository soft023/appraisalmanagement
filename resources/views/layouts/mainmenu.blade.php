...
@csrf
        ...
        <li class="text-center">
                    <img src="staffpics/{{Auth::user()->profilepic}}" class="user-image img-responsive"/>
          </li>
        
                        <!---General Menu -->
                    <li>
                        <a class="active-menu"  href="/home"><i class="fa fa-dashboard fa-3x"></i> My Dashboard</a>
                    </li>
                       <li>
                        ...
                        <li>
                        <a href="#"><i class="fa fa-sitemap fa-3x"></i>Supervisor Menu - {{session('superx')}}<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="superpendingrequest">Pending {{session('superx')}} </a>
                            </li>
                            <li>
                                <a href="/superallresult">History</a>
                            </li>
                        </ul>
                        </li>
                        @endif
                        ...
                        <li>
                        <a href="#"><i class="fa fa-sitemap fa-3x"></i>Fincon Menu - {{session('finx')}} {{session('fnx')}} <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="/finconpendingrequest">Pending {{session('finx')}}</a>
                            </li>
                            <li>
                                <a href="/finconallappraisals">History</a>
                            </li>
                            <li>
                                <a href="/finconlistofrejected">Rejected {{session('fnx')}}</a>
                            </li>
                        </ul>
                        </li>
                        @endif
                     ...
                     <!-- Roles of the HR Menu-->
                      ...
                      <li>
                        <a href="#"><i class="fa fa-sitemap fa-3x"></i>HR Menu - {{session('hr')}}<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                        ...
                        <li>
                        <a href="#"><i class="fa fa-sitemap fa-3x"></i>MD Menu - {{session('md')}}<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="/mdlistofallstaff">All Staff</a>
                            </li>
                            <li>
                                <a href="/mdpendingrequest">Pending</a>
                            </li>
                            <li>
                                <a href="/mdgeneralpendinglist">All Pending</a>
                            </li>
                            <li>
                                <a href="/mdallappraisals">History</a>
                            </li>
                        </ul>
                        </li>
                     @endif
