                            ...
                            <div class="panel-body text-center">
                               <form method="POST" action="{{ route('login') }}">
                                     ...
                                     <div class="form-group input-group" >
                                            <span class="input-group-addon w3-text-white" style="background: #8d219c"><i class="fa fa-tag"  ></i></span>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <button type="submit" class="btn btn-primary w3-text-white"  style="background: #8d219c;"> Login Now</button>
